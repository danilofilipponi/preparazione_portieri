-- Abilita in modo esplicito un esercizio del catalogo come esercizio valutativo.
-- Non modifica i mapping esistenti in modo massivo e non cambia RLS.
...
begin
  ...
  insert into public.exercise_evaluation_targets (
    ...
    'Technical',
    requested_technical_subcategory_id,
    null,
    0.850,
    0.850,
    0.900,
...
comment on function public.set_exercise_evaluation_eligibility(uuid,integer,boolean,text) is
  'Crea o aggiorna il mapping tecnico manuale che rende un esercizio disponibile nelle sedute di valutazione.';

commit;

select 'MIGRATION 0038 PREPARATA: NEW EXERCISE EVALUATION ELIGIBILITY' as risultato;
