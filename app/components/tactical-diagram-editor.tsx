...
export function TacticalDiagramEditor({ exercise, value, onSave, onCancel }: Props) {
  ...
  return <section className="tactical-editor" aria-label="Editor schema tattico">
    ...
    {localRendererComparison && <details className="tactical-renderer-comparison"><summary>Confronto V2 Refined 2D / V2 Final Perspective</summary><div><section><b>V2 Refined 2D · stesso JSON</b><ExerciseTacticalBoard diagram={diagram} rendererVersion="v2-refined" /></section><section><b>V2 Final Perspective · stesso JSON</b><ExerciseTacticalBoard diagram={diagram} rendererVersion="v2-final" /></section></div></details>}
