...
type Props = {
  ...
  reassessmentBaselines: GoalkeeperEvaluationHistorySession[];
...
export function EvaluationSessionWizard(props: Props) {
  ...
  const eligibleReassessmentBaselines = useMemo(
    () => props.reassessmentBaselines.filter(item => item.goalkeeperId === goalkeeperId),
    [goalkeeperId, props.reassessmentBaselines],
  );
